...
// 메소드(Method) : 클래스 내부에 선언된 함수 - 멤버 함수
...
// => 메소드에 작성된 명령을 실행하기위해 메소드 호출시 전달될 값을 저장하기 위한 변수
...
// => 메소드의 반환형을 [void]로 작성
// 형식 2) return 대상;
// => 메소드를 종료하면서 대상(변수 또는 연산식)의 값을 반환하여 메소드를 호출하는 명령에게 제공
...
//		}
	...
	/*
	 * 매개변수 생략 기호(...)를 사용하여 매개변수를 작성하면 값을 0개 이상 전달받아 메소드에서 배열처럼 사용 가능
	 */
