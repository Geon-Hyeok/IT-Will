...
// 			public static final 자료형 필드명  = 값; // -> public static final 생략 가능
//			...
//			public abstract 반환형 메소드명(자료형 매개변수, ...); // -> public abstract 생략 가능
// 			...
// }
...
// => 인터페이스를 상속받은 자식 클래스는 무조건 상속받은 인터페이스의 무든 추상메소드를 오버라이드 선언
