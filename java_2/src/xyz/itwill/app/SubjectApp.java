...
// 형식) package 패키지경로;  >> ex) package xyz.itwill.app;
// => Java 자료형이 어떤 패키지에서 선언된 자로형인지를 명확하게 구분하여 사용

// import 키워드 : 다른 패키지에 작성된 Java 자료형을 명확히 표현하여 접근하기 위한 키워드
// 형식) import 패키지경로.자료형; >> 자료형 대신 *(전체) 사용 가능 >> ex) import xyz.itwill.subject.*;
...
public class SubjectApp {
	public static void main(String[] args) {
		// 같은 패키지에 작성된 클래스는 패키지 경로 표현 없이 클래스만 사용하여 접근 가능
		// => 형식) 클래스명
