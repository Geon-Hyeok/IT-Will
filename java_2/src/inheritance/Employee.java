...
public abstract class Employee {
	...
	*/
	...
	// 자식클래스에서 부모클래스의 메소드를 무조건 오버라이드 선언되도록 설정하기 위해 
	...
	// => 자식클래스에서 추상메소드를 오버라이드 선언하지 않으면 자식클래스도 추상클래스로 설정
	public abstract int computePay();
	
	// 인센티브를 계산하여 반환하는 메소드
	// => 모든 사원에게 급여의 150%를 인센티브로 제공되도록 계산
	// 자식클래스에서 메소드를 오버라이드 선언하면 비정상적인 결과 발생
