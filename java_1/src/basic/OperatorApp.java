...
public class OperatorApp {
	...
	public static void main(String[] args) {
		...
		// => ~ : Bit Not 연산자(1의 보수 연산자) : 정수값으로 표현된 Bit단위의 값을 반대로 변환하는 연산자
		// => ! : Not 연산자 : 정수값으로
		...
		// => new : 객체 생성 연산자 - 클래스의 생정자를 호출하여 객체를 생성하기 위한 연산자
		...
		// 하나의 연산식으로 구현된 단일 명령인 경우 연산자의 위치는 결과에 미영향
		...
		// 형식) 조건식 ? 참값 : 거짓값;
		/*
		 * => 조건식(true or false)의 결과값이 true인 경우 참값을 제공하고 false인 경우 거짓값을 제공한다.
		 */
