...
// => 비교대상의 값을 case 키워드로 제공된 값과 차례대로 비교하여 
// 	  같은 case 키워드의 값을 가지고 있는 위치로부터 작성된 모든 명령 실행
// => case 키워드로 제공되는 값은 리터럴 또는 상수(Constant)만 작성 가능
// => case 키워드로 제공되는 값이 중복되어 작성될 경우 에러 발생
// => break 키워드를 만나면 switch 구문 강제 종료
// => case 키워드로 제공되는 값이 모두 다른 경우 default 키워드의 명령 실행 - 생략가능
...
public class SwitchApp {
	public static void main(String[] args) {
		...
		System.out.println("========================================");
		  ...
		  // 모두 다른 경우 default값이 있을 때 default값 실행
