...
// => java.awt의 확장 패키지 - Java 컴퍼넌트 제공

// 컴퍼넌트(Component) : GUI 프로그램에서 UI(User Interface)를 구현하기 위한 클래스
...
public class FrameOneApp {
	public static void main(String[] args) {
		...
		// Component.setVisible(boolean b) : 컴퍼넌트를 보이지 않게 처리하거나 보여지도록
		// 처리하는 메소드 - false : 보이지 않도록 처리, true : 보여지도록 처리
