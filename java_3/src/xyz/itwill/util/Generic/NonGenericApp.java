package xyz.itwill.util.Generic;

// Object 타입 필드가 선언된 클래스로 객체를 생성하여 사용하는 프로그램
// => Object 타입 필드에 모든 클래스의 객체를 전달하여 저장 가능
...
public class NonGenericApp {
	public static void main(String[] args) {
		...
		if(nonGeneric2.getField() instanceof Double) {
			...
			System.out.println("필드값 = " + returnObject2); // Double 객체 >> 실수값
		}
		System.out.println("============================");
