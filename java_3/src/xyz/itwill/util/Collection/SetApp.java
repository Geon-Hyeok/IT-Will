...
// 콜렉션 클래스(Collection Class) : 자료구조(Data Structure)를 사용하여 객체를 효율적으로
// 관리(추가, 삭제, 검색)하기 위한 기능을 제공하는 데이터 수집 클래스들을 표현
// => Collection 인터페이스(Set 인터페이스, List 인터페이스, Map 인터페이스 등) 중 하나를 상속받아 작성된 클래스

// Set 인터페이스를 상속받은 콜렉션 클래스 - HashSet, TreeSet, LinkedHashSet, 등
// => 중복된 값을 허용하지 않는 자료구조
...
public class SetApp {
	public static void main(String[] args) {
		...
		// => HashSet 객체에는 모든 자료형의 객체를 Object 타입으로 저장 가능
		...
		// 요소(Element) : 콜렉션 클래스의 객체에 저장되는 객체
		set.add("홍길동");
		set.add("임꺽정");
		set.add("림철주");
		...
		// Set 객체에는 동일한 객체가 중복 저장되는 것을 방지
		set.add("홍길동");
		System.out.println("set = " + set);
		System.out.println("============================================");
		
		// Set.size() : Set 객체에 저장된 요소의 객체 갯수를 반환하는 메소드
