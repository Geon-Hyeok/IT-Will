...
// Wrapper 클래스 : 원시형을 클래스로 선언한 자료형을 일괄적으로 표헌하기 위한 이름
// => (원시형 자료형) Byte, Short, Integer, Long, Float, Double, Character, Boolean
// => 원시형 대신 객체로 표현하기 위한 사용 클래스
public class Wrapper {
	public static void main(String[] args) {
		...
		// Integer.intValue() : Integer 객체에 저장된 정수값으로 반환하는 메소드
		...
		*/
		...
		// 오토박싱(AutoBoxing) : 원시형 리터럴(값)을 JVM이 자동으로 Wrapper 클래스의 객체로 생성하여 제공하는 기능
		// 오토언박싱(AutoUnBoxing) : JVM이 자동으로 Wrapper 클래스의 객체에 저장된 값을 원시형 리터럴로 제공       하는 기능
		Integer num1 = 100, num2 = 200;
		Integer num3 = num1+num2;
		System.out.println("num3 = " + num3);
		System.out.println("================================================");

		// Integer.valueOf(String s, int radix) : 매개변수로 전달받은 값으로 원하는 진수의 문자열을
		...
		// Integer.HexString((int i) : 매개변수로 전달된 정수값을 16진수 형태의 문자열로 반환하는 메소드
		// Integer.toOctalString(int i) : 매개변수로 전달된 정수값을 8진수 형태의 문자열로 반환하는 메소드
		// Integer.toBinaryString((int i) : 매개변수로 전달된 정수값을 2진수 형태의 문자열로 반환하는 메소드
