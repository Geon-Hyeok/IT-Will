...
// => 주민번호는 14자리로 입력하고 7번째 자리에 반드시 - 문자가 존재
// => 비정상적인 주민번호가 입력된 경우 에러메세지를 출력후 재입력되도록 처리
// ex) 주민번호[ex.901225-1234567] >>
...
public class PersonNumberApp {
	public static void main(String[] args) {
		...
		while (true) {
			...
			// 키보드로 입력받은 문자열에서 앞과 뒤의 공백을제거하여 반환받아 변수에 저장
			...
			System.out.println("[에러] 형식에 맞게 주민번호를 입력 해주세요");
		}
		scanner.close();
